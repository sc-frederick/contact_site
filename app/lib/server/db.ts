...
const mockPortfolioItems: PortfolioItem[] = [
  ...
  },
  {
    id: 10,
    title: 'CafeFit',
    description: 'Fitness tracking Progressive Web App for calorie tracking, weight management, and workout logging with offline support. Built with TanStack Start on Cloudflare Workers with D1 SQLite database.',
    image_url: '',
